...
class TestCase(unittest.TestCase):
	...
	def test_obter_usuarios(self):
		db.session.add(Usuario('Auceliano', '88 9 9247 3860', 'n.a.n.d.o_@outlook.com', 'admin', 'A'))
		db.session.add(Usuario('José', '88 9 9999 9999', 'umoutroalguem@outlook.com', 'admin', 'F'))
		db.session.add(Usuario('Um Zé ninguem', '88 8 8888 8888', 'zéninguem@outlook.com', 'admin', 'C'))
		db.session.commit()
	...
	def test_inserir_usuario(self):
		inserir_usuario('Desmeliedison Jerry Junior', '88 9 6969 9696', 'desmeliedison@gmail.com', 'admin', 'A')
	...
	def test_atualizar_usuario(self):
		inserir_usuario('Desmeliedison Jerry Junior', '88 9 6969 9696', 'desmeliedison@gmail.com', 'admin', 'A')
		atualizar_usuario(0, 'Atualizado', 'Atualizado', 'Atualizado', 'admin', 'A')
